...
from hate.entity.config_entity import DataTransformationConfig,ModelPusherConfig
...
class PredictionPipeline:
    ...
    def get_model_from_gcloud(self) -> str:
        ...
        try:
            ...
            file_path = os.path.join(parent_directory,'best_model_location','best_model_location.txt')
            
            with open(file_path, 'r') as file:
                best_model_path = file.read()
            
            logging.info("Exited the get_model_from_gcloud method of PredictionPipeline class, got the best model path -->")
            logging.info(best_model_path+'\model.h5')
            return best_model_path+'\model.h5'
